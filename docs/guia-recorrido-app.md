...
| **WS-7** Corrección de datos del plantel | Podrás corregir los datos del inmueble (por ejemplo, metros totales mal escritos) mientras el plantel solo lo usen tus niveles aún en captura. El domicilio sigue siendo de solo lectura. | Tu autorización (D8 ya decidida). |
...
- **El responsable legal no se puede editar** una vez guardado.
